...
int main(int argc, char *argv[])
{
  ...
  18:	a1 7c 0b 00 00       	mov    0xb7c,%eax
  total_waittime=0;
  1d:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
  24:	00 00 00 
  total_runtime=0;
  27:	c7 05 8c 0b 00 00 00 	movl   $0x0,0xb8c
  2e:	00 00 00 
  for (j = 0; j < number_of_processes; j++)
  31:	85 c0                	test   %eax,%eax
  33:	7e 42                	jle    77 <main+0x77>
  ...
  49:	39 1d 7c 0b 00 00    	cmp    %ebx,0xb7c
  4f:	7e 26                	jle    77 <main+0x77>
    int pid = fork();
  51:	e8 55 03 00 00       	call   3ab <fork>
    if (pid < 0)
  56:	85 c0                	test   %eax,%eax
  58:	79 e6                	jns    40 <main+0x40>
      printf(1, "Fork failed\n");
  ...
  65:	6a 01                	push   $0x1
  67:	e8 b4 04 00 00       	call   520 <printf>
      continue;
  6c:	83 c4 10             	add    $0x10,%esp
  for (j = 0; j < number_of_processes; j++)
  6f:	39 1d 7c 0b 00 00    	cmp    %ebx,0xb7c
  75:	7f da                	jg     51 <main+0x51>
    {      
  ...
  77:	83 3d 7c 0b 00 00 fc 	cmpl   $0xfffffffc,0xb7c
  7e:	7c 3e                	jl     be <main+0xbe>
  80:	31 ff                	xor    %edi,%edi
  82:	8d 75 e4             	lea    -0x1c(%ebp),%esi
  85:	8d 5d e0             	lea    -0x20(%ebp),%ebx
  ...
  96:	56                   	push   %esi
  97:	53                   	push   %ebx
  98:	e8 b6 03 00 00       	call   453 <waitx>
    total_waittime+=waittime;
  9d:	8b 45 e0             	mov    -0x20(%ebp),%eax
  a0:	01 05 90 0b 00 00    	add    %eax,0xb90
  for (j = 0; j < number_of_processes+5; j++)
  a6:	83 c4 10             	add    $0x10,%esp
    total_runtime+=runtime;
  a9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  ac:	01 05 8c 0b 00 00    	add    %eax,0xb8c
  for (j = 0; j < number_of_processes+5; j++)
  b2:	a1 7c 0b 00 00       	mov    0xb7c,%eax
  b7:	83 c0 04             	add    $0x4,%eax
  ba:	39 f8                	cmp    %edi,%eax
  bc:	7d d2                	jge    90 <main+0x90>
  }
  printf(1, "TOTAL WAIT TIME: %d  TOTAL RUN TIME: %d\n", total_waittime, total_runtime);
  be:	ff 35 8c 0b 00 00    	pushl  0xb8c
  c4:	ff 35 90 0b 00 00    	pushl  0xb90
  ca:	68 98 08 00 00       	push   $0x898
  cf:	6a 01                	push   $0x1
  d1:	e8 4a 04 00 00       	call   520 <printf>
  exit();
  d6:	e8 d8 02 00 00       	call   3b3 <exit>
      for (volatile int k = 0; k < number_of_processes; k++)
  db:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  e2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  e5:	3b 05 7c 0b 00 00    	cmp    0xb7c,%eax
  eb:	7c 24                	jl     111 <main+0x111>
  ed:	eb 56                	jmp    145 <main+0x145>
  ef:	90                   	nop
          sleep(50); //io time
  f0:	83 ec 0c             	sub    $0xc,%esp
  f3:	6a 32                	push   $0x32
  f5:	e8 49 03 00 00       	call   443 <sleep>
 ...
 109:	3b 05 7c 0b 00 00    	cmp    0xb7c,%eax
 10f:	7d 34                	jge    145 <main+0x145>
        if (k <= j)
 111:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 114:	39 d8                	cmp    %ebx,%eax
 116:	7e d8                	jle    f0 <main+0xf0>
          for (i = 0; i < 100000000; i++)
 118:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
 11f:	8b 45 e0             	mov    -0x20(%ebp),%eax
 122:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
 127:	7f d4                	jg     fd <main+0xfd>
 129:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 130:	8b 45 e0             	mov    -0x20(%ebp),%eax
 133:	83 c0 01             	add    $0x1,%eax
 136:	89 45 e0             	mov    %eax,-0x20(%ebp)
 139:	8b 45 e0             	mov    -0x20(%ebp),%eax
 13c:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
 141:	7e ed                	jle    130 <main+0x130>
 143:	eb b8                	jmp    fd <main+0xfd>
      exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	eb 1a                	jmp    6c0 <printf+0x1a0>
          s = "(null)";
 6a6:	bb c1 08 00 00       	mov    $0x8c1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f5:	a1 80 0b 00 00       	mov    0xb80,%eax
{
...
malloc(uint nbytes)
{
 ...
 78d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 790:	8b 3d 80 0b 00 00    	mov    0xb80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 802:	e8 e9 fe ff ff       	call   6f0 <free>
  return freep;
 807:	a1 80 0b 00 00       	mov    0xb80,%eax

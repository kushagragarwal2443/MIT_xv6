  ...
  16:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
{
  ...
  20:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    ...
    pid = fork();
  27:	e8 af 02 00 00       	call   2db <fork>

    if(pid == 0)
  2c:	85 c0                	test   %eax,%eax
  2e:	75 3a                	jne    6a <main+0x6a>
    {
        // ps();
        exec(argv[1],&argv[1]);
  30:	8d 43 04             	lea    0x4(%ebx),%eax
  33:	52                   	push   %edx
  34:	52                   	push   %edx
  35:	50                   	push   %eax
  36:	ff 73 04             	pushl  0x4(%ebx)
  39:	e8 dd 02 00 00       	call   31b <exec>
        printf(1, "exec %s has failed\n", argv[1]);
  3e:	83 c4 0c             	add    $0xc,%esp
  41:	ff 73 04             	pushl  0x4(%ebx)
  44:	68 b8 07 00 00       	push   $0x7b8
  49:	6a 01                	push   $0x1
  4b:	e8 00 04 00 00       	call   450 <printf>
  ...
  6a:	50                   	push   %eax
  6b:	50                   	push   %eax
  6c:	8d 45 f4             	lea    -0xc(%ebp),%eax
  6f:	50                   	push   %eax
  70:	8d 45 f0             	lea    -0x10(%ebp),%eax
  73:	50                   	push   %eax
  74:	e8 0a 03 00 00       	call   383 <waitx>
  79:	83 c4 10             	add    $0x10,%esp
  7c:	eb d5                	jmp    53 <main+0x53>
  7e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb ea 07 00 00       	mov    $0x7ea,%ebx
        while(*s != 0){

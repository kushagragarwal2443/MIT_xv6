...
int main(int argc, char *argv[])
{
  ...
  39:	7e 05                	jle    40 <main+0x40>
    {
        input_value = 100;
  3b:	bb 64 00 00 00       	mov    $0x64,%ebx
    }
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb d7 07 00 00       	mov    $0x7d7,%ebx
        while(*s != 0){
